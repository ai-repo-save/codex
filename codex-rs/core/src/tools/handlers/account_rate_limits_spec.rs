...
pub fn create_get_account_rate_limits_tool() -> ToolSpec {
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: "Returns the current ChatGPT account rate-limit buckets, including used and remaining percentages for each window. Returns a structured unavailable result when the current provider or authentication mode cannot query account limits."
            .to_string(),
        strict: false,
        defer_loading: None,
