...
pub struct MemoriesToml {
    ...
    /// When `false`, disable session/project scoped memory tools and prompt context.
    pub use_scoped_memories: Option<bool>,
...
impl From<MemoriesToml> for MemoriesConfig {
    fn from(toml: MemoriesToml) -> Self {
        ...
        Self {
            ...
            use_scoped_memories: toml
                .use_scoped_memories
                .unwrap_or(defaults.use_scoped_memories),
