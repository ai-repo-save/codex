 ...
 */
agentsStates: { [key in string]?: CollabAgentState }, } | { "type": "subAgentActivity", id: string, kind: SubAgentActivityKind, agentThreadId: string, agentPath: string, operation: SubAgentActivityOperation | null, outcome: SubAgentActivityOutcome | null, model: string | null, reasoningEffort: ReasoningEffort | null, } | { "type": "memoryMutation" } & MemoryMutation | { "type": "webSearch" } & WebSearchItem | { "type": "imageView", id: string, path: LegacyAppPathString, } | { "type": "sleep", id: string, durationMs: number, } | { "type": "imageGeneration" } & ImageGenerationItem | { "type": "enteredReviewMode", id: string, review: string, } | { "type": "exitedReviewMode", id: string, review: string, } | { "type": "contextCompaction", id: string, } | { "type": "contextAnchorSaved", id: string, anchorId: string, label: string | null, historyBoundary: bigint, createdAt: bigint, } | { "type": "contextAnchorRewound", id: string, anchorId: string, droppedTurns: number, responseItemsReclaimed: bigint, approxTokensReclaimed: bigint, reclaimThresholdPercent: number, reclaimThresholdTokens: bigint | null, reclaimThresholdMet: boolean | null, };
