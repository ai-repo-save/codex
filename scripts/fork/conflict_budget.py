...
HOT_FILES = (
    ...
    "codex-rs/tui/src/multi_agents/mod.rs",
    "codex-rs/tui/src/multi_agents/activity.rs",
    "codex-rs/tui/src/multi_agents/history_cells.rs",
    "codex-rs/tui/src/multi_agents/render.rs",
